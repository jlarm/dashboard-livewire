...
use App\Jobs\SeedDefaultUsersJob;
use App\Jobs\SeedDepartmentsJob;
use App\Jobs\SeedRolesAndPermissionsJob;
        ...
        return [
            ...
            TenantCreated::class => [
                JobPipeline::make([
                    ...
                    SeedRolesAndPermissionsJob::class,
                    SeedDepartmentsJob::class,
                    SeedCoursesJob::class,
                    SeedDefaultUsersJob::class,
