...
class Main extends Component
{
    ...
    public function mount(Request $request): void
    {
        ...
        $this->phishingIsEnabled = self::$cachedPhishingIsEnabled ??= (bool) GlobalSetting::query()->first()?->phishing_active;

        $store = $this->currentStore ?? resolve('currentStoreModel') ?? Store::query()->first();
