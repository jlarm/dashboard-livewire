...
* @route '/livewire-2084ab44/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-2084ab44/upload-file',
...
* @route '/livewire-2084ab44/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-2084ab44/preview-file/{filename}',
