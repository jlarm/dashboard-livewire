...
* @route '/livewire-2084ab44/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-2084ab44/livewire.js',
...
* @route '/livewire-2084ab44/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-2084ab44/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-2084ab44/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-2084ab44/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
