...
* @see app/Http/Controllers/Central/DealershipController.php:21
* @route '//dashboard-vue.test/dealerships'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '//dashboard-vue.test/dealerships',
...
* @see app/Http/Controllers/Central/DealershipController.php:38
* @route '//dashboard-vue.test/dealerships'
*/
